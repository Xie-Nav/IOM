...
from utils.class_finder import agent_class, model_class, optimizer_class
...
def main():
    ...
    # 【】【】这里改过
    results_file = "result_epoch.txt" 
    with open(results_file, "a") as f:
        txt = "datetime{}".format(datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
        f.write(txt+"\n")                   
    ...
    try:
        while train_total_ep < args.max_ep:   
            ...
            if (train_total_ep % train_thin) == 0:   
                ...
                #
                print('epoch:{} ep_length:{} Reward:{}'.format(train_total_ep,  tracked_means['ep_length'], tracked_means['total_reward']))
                with open(results_file, "a") as f:
                    txt = 'epoch:{} ep_length:{} Reward:{}'.format(train_total_ep,  tracked_means['ep_length'], tracked_means['total_reward'])
                    f.write(txt+"\n")
