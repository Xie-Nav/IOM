...
class ThorAgent:
    ...
    def action(self, model_options, training, test_update):
        ...
        model_input, out = self.eval_at_state(model_options, self.episode.environment.last_action_success)
        ...
        self.imp_obstacle_map = out.imp_obstacle_map
        self.obstacle_index = out.obstacle_index
        ...
        self.reward, self.done, self.info = self.episode.step(action[0, 0], self.start_coord, self.obstacle_index, self.imp_obstacle_map)
        self.action_num += 1
